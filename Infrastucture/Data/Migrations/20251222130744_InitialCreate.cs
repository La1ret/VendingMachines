    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin@mail.ru", 0, "Администратор", null, "$2a$11$WUTkxON8RaqF6Mcedyhbxu4dvdSFrxGSjBeln66g/rcQCxk7In8DC", 1, "Admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "FailedLoginAttempts", "FullName", "LockoutEnd", "PasswordHash", "RoleId", "Username" },
                values: new object[] { 2, "Operator@yandex.ru", 0, "Опреатор", null, "$2a$11$acEuZ0Or73p7DMBzMQAndecUCN7h6igInrYI46fWEJzvGZXPMJWUu", 2, "Operator" });
